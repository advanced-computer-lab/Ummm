    ...
    Swal.fire(
      ...
      .then((res) => {
        if (res.isConfirmed) {
              ...
              // HERE WILL CALL THE FUNCTION THAT REMOVE THE RESERVATION FROM SCREEN AND BACK END
  ...
  swalWithBootstrapButtons.fire({
        ...
        '<div class="inner-wrapper">'+
          '<div class="details">'+
            ...
            '<div class="plane"></div>'+
            '<div class="content">'+
              '<div class="gate">2B <span>Terminal</span></div>'+
          ...
          '<div class="seat-layout">'+
            '<div class="content">'+
              ...
              '<div class="Terminal">2B <span>gate</span></div>'+
