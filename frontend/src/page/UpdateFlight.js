...
//  }
  ...
  const updateHandler = (e,flight) => {
    ...
    && Data.To.trim().length==3 && !Data.To.trim().includes(" ")&&Data.Flight_Date!==null &&/^[A-Za-z\s]*$/.test(Data.To.trim())
      &&Data.Terminal!==''&& Data.Economy_Seats!==null&& Data.First_Seats!==null&& Data.Business_Seats!==null 
      && Data.Economy_Baggage!==null&& Data.First_Baggage!==null&& Data.Business_Baggage!==null
      &&Data.Economy_Price!==null&& Data.First_Price!==null&& Data.Business_Price!==null
      && Data.Flight_DHour !== null&& Data.Flight_DMin !== null
      ){
        console.log(Data);
  ...
  else if (Data.Flight_Date == null) {
    warning4();
  }
 

  else if (Data.Flight_DHour == null) {
    warning115();
  }
  else if (Data.Flight_DMin == null) {
    warning116();
  }
  ...
  else if (Data.Economy_Seats== null) {
    warning7();
  }
  else if (Data.Business_Seats== null) {
    warning8();
  }
  else if (Data.First_Seats== null) {
    warning9();
  }



  else if (Data.Economy_Baggage == null) {
    warning10();
  }
  else if (Data.Business_Baggage == null) {
    warning11();
  }
  else if (Data.First_Baggage == null) {
    warning12();
  }
  ...
  else if (Data.Economy_Price == null) {
    warning13();
  }
  else if (Data.Business_Price == null) {
    warning14();
  }

  else if (Data.First_Price == null) {
    warning15();
  }
...
const success = () => {
  message.success('Flight Successfully Updated!');
};
...
<div class="limiter">
    ...
    <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
      <form class="login100-form validate-form">
        ...
        <div class="wrap-input100 validate-input m-b-23" data-validate="Flight Date is reauired">
            ...
            Color:"white",    
          }}type="date" format="DD-MM-YYYY" defaultValue={moment(Data.Flight_Date)} format="DD-MM-YYYY, HH:mm"
  ...
  <path d="M9.998 5.083 10 5a2 2 0 1 0-3.132 1.65 5.982 5.982 0 0 1 3.13-1.567z"/>
        ...
        <a class="button-60 center20" role="button" onClick={(e) => updateHandler(e,UpFlight)}>Update Flight</a>
